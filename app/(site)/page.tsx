...
export default async function Home() {
  ...
  return (
    <div className="max-w-5x1 mx-auto py-20">
      <h1 className="text-7x1 font-extrabold">
        Ola eu sou o {" "}
    ...
    <p className="mt-3 text-x1 text-gray-600">Bem- vindos! Deem uma olhada na pagina!</p>

    <h2 className="mt-24 font-bold text-gray-700 text-3x1">Meus Projetos</h2>
